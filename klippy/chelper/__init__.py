...
SOURCE_FILES = [
    ...
    'kin_extruder.c', 'kin_shaper.c', 'kin_idex.c', 'kin_fouraxes.c',
]
...
defs_kin_fouraxes = """
    struct stepper_kinematics *fouraxes_stepper_alloc(char axis);
"""
...
defs_all = [
    ...
    defs_kin_extruder, defs_kin_shaper, defs_kin_idex, defs_kin_fouraxes,
]
