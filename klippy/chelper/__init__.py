...
SOURCE_FILES = [
    ...
    'kin_extruder.c', 'kin_shaper.c', 'kin_idex.c', 'kin_galvo.c',
]
...
defs_kin_galvo = """
    struct stepper_kinematics *galvo_stepper_alloc(char axis);
"""
...
defs_all = [
    ...
    defs_kin_extruder, defs_kin_shaper, defs_kin_idex, defs_kin_galvo,
]
